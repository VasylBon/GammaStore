...
const date = (id, deadline) => {
  function convertDateToWord() {
    const parts = deadline.split("-"),
      month = parts[1],
      days = parts[2];
    let monthsWord = ["січня", "лютого", "березня", "квітня", "травня", "червня", "липня", "серпня", "вересня", "жовтня", "листопада", "грудня"];
...
const forms = () => {
  ...
  const message = {
    loading: "Відправляємо дані...",
    success: "Дякуємо! Оператор скоро зв'яжеться з вами",
    failure: "Виникла помилка відправлення даних. Спробуйте знову."
  };
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  (0,_modules_date__WEBPACK_IMPORTED_MODULE_2__["default"])(".container1", deadline);
